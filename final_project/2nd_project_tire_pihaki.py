    ...
    try:
        while True:
            ...
            if avoid_mode:
                ...
                LEFT_FIRST_STEER = 0.45
                RIGHT_FIRST_STEER = 0.65

                LEFT_RETURN_STEER = 0.45
                RIGHT_RETURN_STEER = 0.65

                if t < 0.7:

                    if avoid_dir == 1:
                        steering = LEFT_FIRST_STEER
                    else:
                        steering = -RIGHT_FIRST_STEER
                    ...
                    if avoid_dir == 1:
                        steering = -LEFT_RETURN_STEER
                    else:
                        steering = RIGHT_RETURN_STEER
